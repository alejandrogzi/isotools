...
//!
//! ```bash
//! iso-orphan --bed tests/data/mm39.bed --overlapping --outdir tests/data --name test --threads 1
//! ```
//!
//! ```bash
//!  iso-orphan -b tests/data/mm39.bed -t tests/data/mm39.toga.bed -N test -T 1
//! ```
